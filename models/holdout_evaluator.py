...
Responsibilities
----------------
- Evaluate the selected model on the unseen test split
- Calculate final evaluation metrics

This is production training code, not a unit-test module. It used to be
called `test_evaluator.py`, which put it one `pytest` invocation away
from being collected as a test file it never was.
=========================================================
"""
