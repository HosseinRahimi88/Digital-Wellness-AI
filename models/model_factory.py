...
def _get_classification_models(random_state: int) -> Dict[str, BaseEstimator]:
    ...
    # Retuned once per-user trend features were added: with ~130 extra
    # correlated columns, shallower trees and a slower rate generalise
    # better than the previous deeper/faster config. Selected on the
    # validation split only (best of six configs, 0.9142 vs 0.9034-0.9113
    # for the alternatives); see models/research_classification_trend.py.
