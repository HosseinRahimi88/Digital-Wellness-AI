...
### 3. [Bug] Dead code hiding a missing UI feature — `app/components/improvement_chain.py`
...
### 4. [Minor] Pointless f-string — `app/pages/Analytics.py:383`
