...
(function () {
  ...
  /* The pace and the work-screen answer. Both were hard-coded in the
     client until now - submitted on the user's behalf and read by
     nothing. `low|moderate|high` matches Account.preferred_effort. */
  const EFFORT_OPTIONS = {
    'Gently — small steps I can keep': 'low',
    'A steady pace': 'moderate',
    'Push me — I want a real change': 'high',
  };
  const WORK_SCREEN_OPTIONS = {
    'Yes, a screen is my work': 'yes',
    'No, I can step away from it': 'no',
  };
  ...
  const OPTION_LABELS = {
    ...
    low: { en: "Gently — small steps I can keep", fa: "آرام — قدم‌های کوچکی که بتوانم نگه دارم", ar: "برفق — خطوات صغيرة أستطيع الحفاظ عليها", zh: "温和一些——我能坚持的小步子" },
    moderate: { en: "A steady pace", fa: "با سرعتی پیوسته", ar: "بوتيرة ثابتة", zh: "稳定的节奏" },
    high: { en: "Push me — I want a real change", fa: "فشار بیاور — تغییر واقعی می‌خواهم", ar: "ادفعني — أريد تغييراً حقيقياً", zh: "推我一把——我想要真正的改变" },
    yes: { en: "Yes, a screen is my work", fa: "بله، کارم روی صفحه است", ar: "نعم، عملي على الشاشة", zh: "是的，我的工作就在屏幕上" },
    no: { en: "No, I can step away from it", fa: "نه، می‌توانم از آن فاصله بگیرم", ar: "لا، أستطيع الابتعاد عنها", zh: "不，我可以离开它" },
