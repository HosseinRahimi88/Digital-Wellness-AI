/*
  ...
  Every answer below is checked against the service that implements it:
    · services/day_status_service.py    - the four colours and the halves
    · services/violation_service.py     - badge spent, then violation
    · services/day_decision_service.py  - exception vs counted, 0.25
    · services/plan_lock_service.py     - one plan per ISO week
    · services/plan_progress_service.py - ticks per (week, day, task)
