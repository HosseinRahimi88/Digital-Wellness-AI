...
simulator (app/components/what_if_simulator.py) already uses -
...
up to 3 times, which app/pages/What_If_Simulator.py does directly.
...
class AdvancedWhatIfService:
    ...
    def build_scenario_input(base_user_data: dict[str, Any], overrides: dict[str, Any]) -> dict[str, Any]:
        ...
        app/components/what_if_simulator.py's private helper - kept as
        ...
        UI caller (app/pages/What_If_Simulator.py) already bounds every
    ...
    @staticmethod
    def _field_range(field: str, base_value: float) -> tuple[float, float]:
    ...
    def sweep_field(
        ...
        lo, hi = cls._field_range(field, base_value)
