...
class PredictionService:
    ...
    def _prepare_dataframe(
        ...
        # Align columns with feature columns from training
        ...
        if missing:
            ...
            for col in missing:
                if col in categorical_cols:
                    # Leave as NaN -> the OneHotEncoder (handle_unknown='ignore')
                    # will just zero out this column's one-hot slice.
                    continue
    ...
    def predict(
        ...
        SHAP explanation. See services/future_path_service.py,
        services/advanced_whatif_service.py, and
        services/parallel_twin_service.py for the updated call sites.
        """
