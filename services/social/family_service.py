...
Lets multiple accounts (services/identity/account_service.py) opt into a shared
...
DEFAULT_FAMILIES_PATH = paths.storage_file("families.json")
...
class FamilyService:
    ...
    def __init__(self, backend: Optional[StorageBackend] = None) -> None:
        self._backend = backend or backend_for(DEFAULT_FAMILIES_PATH)
