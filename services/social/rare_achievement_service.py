...
achievement track alongside services/social/gamification_service.py's
...
- Cohort-based tiers: this user's own real historical average for a
  ...
  services/ml/cohort_service.py (reused, not re-derived) - e.g. "your
...
- Personal-history tiers: streak length from
  services/social/gamification_service.py.compute_streak() - reused rather
...
from services.ml.cohort_service import CohortService, USER_FIELD_TO_COHORT_FIELD
