...
Analytics Service
--------------------
Pure data-shaping for legacy/streamlit_app/pages/Analytics.py. Every method here takes
...
class AnalyticsService:
    ...
    # see services/identity/history_service.py's own scope note: these methods
