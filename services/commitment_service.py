...
Same storage pattern as services/plan_progress_service.py /
services/letter_service.py: a flat JSON record list via
...
question - see services/recommendation_effectiveness_service.py, which
...
DEFAULT_STORAGE_PATH = Path(__file__).resolve().parent.parent / "storage" / "commitments.json"
