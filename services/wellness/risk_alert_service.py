...
Risk Alert Service
--------------------
Small, rule-based helper (same pattern as services/social/achievement_service.py)
...
from services.identity.report_i18n import FIELD_LABELS
...
# services/ml/prediction_service.py::PredictionService.CLASS_MAPPING) -
