...
Three deliberate constraints shape it:
  ...
  * Badges are computed, not stored (services/badge_service.py derives
...
def unlocked_through(
    ...
    Day 1 is always open. Day N+1 opens once day N is fully done. This
    is what makes the week a sequence instead of a menu - the user
    asked for exactly that, and it is also the only way "you missed a
    day" means anything.
    """
    unlocked = 1
