...
Run: python3 -m unittest tests.test_navigation_and_chart_ui -v
"""
...
class TestPageEnterDoesNotBlankTheContent(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.shell = (JS / "shell.js").read_text(encoding="utf-8")
...
class TestWeekdayChartFillsItsBox(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.charts = (JS / "charts.js").read_text(encoding="utf-8")
