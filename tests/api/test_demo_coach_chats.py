...
Run: python3 -m unittest tests.api.test_demo_coach_chats -v
"""
...
RUNNER = paths.PROJECT_ROOT / "tests" / "js" / "demo_coach_chats_runner.js"
...
class TestDemoCoachChatsSource(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.seeder = (JS / "coach/coach-demo-chats.js").read_text(encoding="utf-8")
        cls.store = (JS / "coach/coach-conversations.js").read_text(encoding="utf-8")
        cls.coach = (JS / "coach/coach.js").read_text(encoding="utf-8")
        cls.demo = (JS / "features/demo.js").read_text(encoding="utf-8")
    ...
    def test_the_seeder_is_wired_into_the_coach_page(self):
        self.assertIn("coach/coach-demo-chats.js", self.page)
        self.assertIn("coach/coach-knowledge-plan.js", self.page)
...
class TestPlanKnowledgeBase(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.kb = (JS / "coach/coach-knowledge-plan.js").read_text(encoding="utf-8")
