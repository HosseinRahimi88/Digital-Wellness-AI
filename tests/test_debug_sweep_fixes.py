...
Run: python3 -m unittest tests.test_debug_sweep_fixes -v
"""
...
class TestTheOnboardingPickersAreTranslated(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.opts = (JS / "onboarding-options.js").read_text(encoding="utf-8")
        cls.app = (JS / "app.js").read_text(encoding="utf-8")
        cls.profile = (JS / "profile.js").read_text(encoding="utf-8")
    ...
    def test_the_submitted_value_is_never_the_translated_text(self):
        ...
        for name, src in (("app.js", self.app), ("profile.js", self.profile)):
