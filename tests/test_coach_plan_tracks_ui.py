...
The service and endpoint are covered by tests/test_signal_tracks.py.
...
Run: python3 -m unittest tests.test_coach_plan_tracks_ui -v
"""
...
class TestCoachPlanTracksUI(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.context = (JS / "coach-context.js").read_text(encoding="utf-8")
        cls.knowledge = (JS / "coach-knowledge.js").read_text(encoding="utf-8")
    ...
    def test_the_chat_module_parses(self):
        ...
        for name in ("coach-chat.js", "coach-context.js", "coach-knowledge.js"):
