...
Run: python3 -m unittest tests.test_day_status_and_demo_states -v
"""
...
class TestDayStatus(unittest.TestCase):
    ...
    def setUp(self):
        from services import day_status_service as svc
        self.svc = svc
...
class TestDemoStatesAreFixed(unittest.TestCase):
    ...
    def setUp(self):
        from services import demo_service as svc
        self.svc = svc
...
class TestTheColoursAreExplainedOnThePage(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.js = (root / "frontend" / "assets" / "js" / "dashboard.js").read_text(encoding="utf-8")
        cls.css = (root / "frontend" / "assets" / "css" / "shell.css").read_text(encoding="utf-8")
        cls.i18n = (root / "frontend" / "assets" / "js" / "i18n.js").read_text(encoding="utf-8")
