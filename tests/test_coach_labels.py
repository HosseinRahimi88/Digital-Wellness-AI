"""window.DWCoachLabels (frontend/assets/js/coach-labels.js) - fixes the
...
LABELS_JS = REPO_ROOT / "frontend" / "assets" / "js" / "coach-labels.js"
...
#     and Chinese. Mirrors services/report_i18n.py FIELD_LABELS, which
...
NON_SCHEMA_LABELS = {"health_score"}
    ...
    def test_coach_labels_script_loads_before_app_js_on_every_page_that_needs_it(self):
        for page in ("app.html", "dashboard.html", "coach.html", "analytics.html"):
            ...
            with self.subTest(page=page):
                self.assertIn('src="assets/js/coach-labels.js"', html)
                labels_pos = html.index('src="assets/js/coach-labels.js"')
                i18n_pos = html.index('src="assets/js/i18n.js"')
...
class TestDashboardCohortCardIsTranslated(unittest.TestCase):
    ...
    scanners in tests/test_i18n_coverage.py catch this class of gap -
    there's no ternary and no if/else branch, just a plain template
    string with never any language check at all."""

    @classmethod
    def setUpClass(cls):
        cls.dashboard_js = (REPO_ROOT / "frontend" / "assets" / "js" / "dashboard.js").read_text(encoding="utf-8")
