...
PROVIDERS = {
    "DWCoachLabels": "coach-labels.js",
    "DWI18n": "i18n.js",
    "DWOnboardingOptions": "onboarding-options.js",
    "DWServerText": "server-text.js",
    "DWCsvLibrary": "csv-library.js",
    "DWFieldGuide": "coach-field-guide.js",
    "DWCurriculum": "coach-curriculum.js",
    "DWBreakdown": "coach-breakdown.js",
}
...
class TestEveryPageLoadsWhatItReads(unittest.TestCase):
    ...
    def test_the_check_can_fail(self):
        ...
        scripts = _scripts_on(page)
        self.assertIn("whatif.js", scripts)
        self.assertTrue(
            _reads("whatif.js", "DWCoachLabels"),
