"""
Tests: services.insight.progress_service, services.insight.insight_service,
utils.persona_titles, utils.data_dictionary and services.wellness.tone_service -
...
Run: python3 -m unittest tests.insight.test_progress_and_insights -v
"""
...
from services.wellness.tone_service import SUPPORTED_TONES, apply_tone, frame_result, normalize_tone
