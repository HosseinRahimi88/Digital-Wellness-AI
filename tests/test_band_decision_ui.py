...
Server behaviour lives in tests/test_day_band_decision.py. This file
...
Run: python3 -m unittest tests.test_band_decision_ui -v
"""
...
class TestBandDecisionUI(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.band_js = (JS / "band-decision.js").read_text(encoding="utf-8")
        ...
        cls.dashboard_js = (JS / "dashboard.js").read_text(encoding="utf-8")
    ...
    def test_both_pages_mount_it(self):
        ...
        self.assertIn("assets/js/band-decision.js", self.app_html)
        self.assertIn("assets/js/band-decision.js", self.weekly_html)
