"""
Tests: services.social.league_service - the Friends League two-sided consent
...
Run: python3 -m unittest tests.social.test_league_service -v
"""
...
class TestConnectionFlow(unittest.TestCase):
    ...
    def test_cannot_connect_to_self(self):
        ...
        from services.social.league_service import LeagueError
