"""
Tests: services/social/badge_service.py (C-3).
...
Run: python3 -m unittest tests.social.test_badge_service -v
"""
...
from services.social.badge_service import (
    CATALOGUE,
...
class TestRegistryCoverage(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        registry = paths.PROJECT_ROOT / "frontend/assets/js/features/badge-registry.js"
