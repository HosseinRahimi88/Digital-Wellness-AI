...
Run: python3 -m unittest tests.social.test_family_service -v
"""
...
from services.social.family_service import (
    FamilyService,
...
class TestFamilyDashboardPrivacy(unittest.TestCase):
    ...
    def test_only_summary_fields_are_exposed_never_raw_habit_data(self):
        ...
        from services.social.family_service import MemberSummary
