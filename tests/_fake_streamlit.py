...
package cannot be installed. To still exercise every `legacy/streamlit_app/pages/*.py`
...
verification still requires `streamlit run legacy/streamlit_app/Home.py` with the real
package installed.
