"""
Tests: execute every real, unmodified `app/pages/*.py` module
...
Run: python3 -m unittest tests.test_pages_smoke -v
"""
...
class TestPagesSmoke(unittest.TestCase):
    ...
    def setUpClass(cls):
        _install_fakes()
        # Home.py bootstraps sys.path itself but isn't under app/pages/.
