...
Run: python3 -m unittest tests.wellness.test_week_progression -v
"""
...
class TestThemeStreaks(unittest.TestCase):
    ...
    def setUp(self):
        from services.wellness import plan_lock_service
...
class TestWeekProgressionIsExplained(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.guide = (root / "frontend" / "assets" / "js" / "guide/guide-tips.js").read_text(encoding="utf-8")
