...
Backend behaviour lives in tests/api/test_history_detail.py. This file pins
...
class TestClickingADayOpensIt(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.dashboard = (JS / "pages/dashboard.js").read_text(encoding="utf-8")
...
class TestAReopenedDayIsMarkedAsPast(unittest.TestCase):
    ...
    def test_the_missing_detail_case_is_told_apart_by_code_not_by_message(self):
        ...
        api_js = (JS / "core/api.js").read_text(encoding="utf-8")
