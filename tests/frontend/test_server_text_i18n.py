...
Run: python3 -m unittest tests.frontend.test_server_text_i18n -v
"""
...
from services.insight.insight_service import (
    LANGUAGES,
    _COLD_START_MESSAGE,
    _CONFIDENCE_DETAIL,
...
RUNNER = paths.PROJECT_ROOT / "tests" / "js" / "server_text_runner.js"
...
class TestEveryPageCanUseIt(unittest.TestCase):
    ...
    def test_the_helper_is_loaded_wherever_i18n_is(self):
        ...
        for html in sorted((REPO_ROOT / "frontend").glob("*.html")):
            ...
            if "assets/js/core/i18n.js" in src and "assets/js/core/server-text.js" not in src:
    ...
    def test_the_consumers_go_through_the_helper(self):
        for name in ("pages/app.js", "pages/dashboard.js", "coach/ai-menu.js"):
