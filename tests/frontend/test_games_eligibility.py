...
four languages), for every game in the real frontend/assets/js/features/games.js -
...
same established pattern as tests/social/test_badge_service.py and
tests/coach/test_coach_nlu_coverage.py, so a change to the real matcher logic
...
of verifying a checker against known-broken input: an empty
...
RUNNER = paths.PROJECT_ROOT / "tests" / "js" / "games_eligibility_runner.js"
...
class TestGamesPageWiring(unittest.TestCase):
    """The placement change: games now live on
    ...
    def setUpClass(cls):
        ...
        cls.games_js = (REPO_ROOT / "frontend" / "assets" / "js" / "features/games.js").read_text(encoding="utf-8")
        cls.app_js = (REPO_ROOT / "frontend" / "assets" / "js" / "pages/app.js").read_text(encoding="utf-8")
        cls.app_chrome_js = (REPO_ROOT / "frontend" / "assets" / "js" / "chrome/app-chrome.js").read_text(encoding="utf-8")
    ...
    def test_the_result_page_no_longer_has_its_own_games_mount(self):
        ...
        # the bottom of the result page regardless of phase. It must not
        # come back. `gamesAfterMount` (below) is a
