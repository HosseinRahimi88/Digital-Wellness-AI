"""
Tests: legacy/streamlit_app/pages/What_If_Simulator.py's Advanced Simulation section
...
model artifacts (same pattern as tests/api/test_pages_smoke.py's
after-a-real-prediction flow) - not just render in their default,
button-not-yet-clicked state.

Run: python3 -m unittest tests.frontend.test_advanced_whatif_page_render -v
"""
...
class TestAdvancedWhatIfPageRender(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # same pattern as tests/api/test_pages_smoke.py's isolation.
        import tempfile
