...
frontend/assets/js/chrome/intro-slides.js is marketing copy that quotes a
...
modules through node the same way tests/coach/test_coach_history_family.py
does. A claim larger than the truth fails; growing the menu never
does.

Run: python3 -m unittest tests.frontend.test_intro_slide_claims -v
"""
...
SLIDES = JS / "chrome/intro-slides.js"
...
def _real_menu_size() -> int:
    ...
    script = (
        ...
        + "".join(
            ...
            for name in (
                "coach/coach-labels.js", "coach/coach-field-guide.js", "coach/coach-curriculum.js",
                "coach/coach-breakdown.js", "coach/coach-history-family.js", "coach/ai-menu.js",
            )
        )
