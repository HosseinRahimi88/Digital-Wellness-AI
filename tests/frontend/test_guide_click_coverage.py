...
Run standalone:
    python3 -m unittest tests.frontend.test_guide_click_coverage -v
"""
...
CLICK_JS = JS_DIR / "guide/guide-click.js"
CONTROLS_JS = JS_DIR / "guide/guide-content-controls.js"
...
def _registered_topics() -> set[str]:
    ...
    tips = (JS_DIR / "guide/guide-tips.js").read_text(encoding="utf-8")
    ...
    for path in JS_DIR.rglob("guide-content-*.js"):
...
def _markup() -> str:
    ...
    chrome = FRONTEND / "assets" / "js" / "chrome/app-chrome.js"
    if chrome.exists():
...
class TestPageWiring(unittest.TestCase):
    ...
    def test_every_shell_page_loads_the_click_layer(self):
        for page in SHELL_PAGES:
            ...
            self.assertIn("guide/guide-click.js", source, page.name)
            self.assertIn("guide/guide-content-controls.js", source, page.name)
    ...
    def test_the_click_layer_loads_after_the_registry_it_extends(self):
        ...
        for page in SHELL_PAGES:
            source = page.read_text(encoding="utf-8")
            self.assertLess(
                source.index("guide/guide-tips.js"), source.index("guide/guide-content-controls.js"), page.name,
            )
    ...
    def test_the_shell_publishes_the_page_key(self):
        ...
        shell = (JS_DIR / "core/shell.js").read_text(encoding="utf-8")
...
class TestBadgesAreClickableEverywhere(unittest.TestCase):
    ...
    def _badge_rendering_files(self) -> list[Path]:
        return [
            path for path in JS_DIR.rglob("*.js")
    ...
    def test_the_profile_preview_reads_the_real_registry(self):
        ...
        source = (JS_DIR / "pages/profile.js").read_text(encoding="utf-8")
    ...
    def test_the_profile_page_loads_the_badge_registry(self):
        ...
        self.assertIn("features/badge-registry.js", source)
        self.assertLess(source.index("features/badge-registry.js"), source.index("pages/profile.js"))
    ...
    def test_hall_tiles_declare_themselves_bound(self):
        ...
        source = (JS_DIR / "features/hall-of-fame.js").read_text(encoding="utf-8")
