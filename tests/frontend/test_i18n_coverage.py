...
Why this exists
----------------
The four language dictionaries in frontend/assets/js/core/i18n.js are
...
Run standalone for a full report:
    python3 -m tests.frontend.test_i18n_coverage
Run as a test:
    python3 -m pytest tests/frontend/test_i18n_coverage.py -v
"""
...
I18N_FILE = PROJECT_ROOT / "frontend" / "assets" / "js" / "core/i18n.js"
