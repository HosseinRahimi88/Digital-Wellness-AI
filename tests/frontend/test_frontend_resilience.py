...
Run: python3 -m unittest tests.frontend.test_frontend_resilience -v
"""
...
class TestNoSignInControlThatCannotWork(unittest.TestCase):
    ...
    def test_the_handler_tolerates_the_button_being_absent(self):
        ...
        it."""
        source = (FRONTEND / "assets" / "js" / "pages/app.js").read_text(encoding="utf-8")
...
class TestTermsPage(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.js = (FRONTEND / "assets" / "js" / "pages/terms-page.js").read_text(encoding="utf-8")
    ...
    def test_the_script_is_external(self):
        ...
        self.assertIn('src="assets/js/pages/terms-page.js"', self.html)
