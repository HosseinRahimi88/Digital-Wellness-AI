...
Run: python3 -m unittest tests.frontend.test_result_framing_i18n -v
"""
...
from services.wellness.tone_service import (
    LANGUAGES,
    SUPPORTED_TONES,
    _RESULT_FRAMING,
    band_for_score,
...
class TestItReachesTheScreen(unittest.TestCase):
    ...
    def test_the_result_screen_picks_the_readers_language(self):
        app_js = (REPO_ROOT / "frontend" / "assets" / "js" / "pages/app.js").read_text(encoding="utf-8")
