...
Run: python3 -m unittest tests.test_recommendation_effectiveness -v
"""
...
from services.commitment_service import Commitment, STATUS_ACTIVE
from services.recommendation_effectiveness_service import RecommendationEffectivenessService
