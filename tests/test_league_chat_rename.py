...
Run: python3 -m unittest tests.test_league_chat_rename -v
"""
...
class TestTheRenameControlExists(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.js = (JS / "league-chat.js").read_text(encoding="utf-8")
...
class TestTheNameIsShownHonestly(unittest.TestCase):
    ...
    def test_the_service_really_does_share_the_name(self):
        ...
        svc = (REPO_ROOT / "services" / "league_chat_service.py").read_text(encoding="utf-8")
...
class TestTheGuideExplainsTheseControls(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.content = (JS / "guide-content-chat.js").read_text(encoding="utf-8")
