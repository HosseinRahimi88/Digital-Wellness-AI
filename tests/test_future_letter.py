...
Run: python3 -m unittest tests.test_future_letter -v
"""
...
RUNNER = Path(__file__).resolve().parent / "js" / "future_letter_runner.js"
...
class TestTheEnvelope(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.js = (JS / "future-letter.js").read_text(encoding="utf-8")
...
class TestTheTextIsTranslated(unittest.TestCase):
    def test_every_letter_line_exists_in_all_four_languages(self):
        js = (JS / "future-letter.js").read_text(encoding="utf-8")
