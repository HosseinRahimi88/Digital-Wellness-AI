...
same category of test A's own tests/storage/test_concurrency.py already runs
for predictions and tests/identity/test_history_storage.py runs for history -
...
Run: python3 -m unittest tests.storage.test_concurrency_new_services -v
"""
...
from services.identity.account_service import AccountService, EmailAlreadyRegisteredError
...
class TestNewServicesSurviveCorruptedStorage(unittest.TestCase):
    ...
    which A's own tests/storage/test_storage_corruption.py already proves is
