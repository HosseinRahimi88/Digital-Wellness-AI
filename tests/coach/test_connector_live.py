...
bodies - and drives the REAL frontend/assets/js/coach/connector.js against it
...
Run: python3 -m unittest tests.coach.test_connector_live -v
"""
...
class TestTheConnectorSourceHoldsItsContract(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.js = (REPO_ROOT / "frontend" / "assets" / "js" / "coach/connector.js").read_text(encoding="utf-8")
