...
Runs the real frontend/assets/js/coach/connector.js and connector-fit.js under
node (tests/js/connector_error_runner.js), same established pattern as
tests/frontend/test_games_eligibility.py and tests/coach/test_coach_nlu_coverage.py.
"""
import json
import shutil
import subprocess
...
RUNNER = paths.PROJECT_ROOT / "tests" / "js" / "connector_error_runner.js"
