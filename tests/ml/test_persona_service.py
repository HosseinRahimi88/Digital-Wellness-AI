...
Run: python3 -m unittest tests.ml.test_persona_service -v
"""
...
from services.ml.persona_service import PersonaService, PersonaResult
...
class TestPersonaModelArtifact(unittest.TestCase):
    ...
    def test_persona_artifact_exists(self):
        from services.ml.persona_service import PERSONA_MODEL_PATH, PERSONA_INFO_PATH
    ...
    def test_persona_info_has_multiple_clusters_with_names(self):
        import json
        from services.ml.persona_service import PERSONA_INFO_PATH
