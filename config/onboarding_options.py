...
profile (services/account_service.py::Account's primary_goal /
main_use_purpose / schedule_type fields). Ported from the Parisa
project's GOAL_OPTIONS / PURPOSE_OPTIONS / SCHEDULE_OPTIONS.

Extracted from app/pages/Onboarding.py into its own module so
app/pages/Profile.py can reuse the exact same option set when editing
