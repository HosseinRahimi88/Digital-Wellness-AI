...
----------------------------
Small display-tuning constants for app/pages/Analytics.py, pulled out
...
# services/analytics_service.py. Each threshold is the smallest sample
...
# Display labels for health_score + every services.history_service
...
# Leverage Day) - see services/analytics_service.py. Same rationale
