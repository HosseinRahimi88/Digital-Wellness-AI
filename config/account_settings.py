...
services/identity/account_service.py so the threshold isn't a magic number
buried in business logic (and so legacy/streamlit_app/pages/Login.py doesn't need its
...
# (legacy/streamlit_app/pages/Login.py) - moving the *enforcement* into
