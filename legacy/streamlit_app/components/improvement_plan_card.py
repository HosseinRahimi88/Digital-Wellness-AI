...
services.wellness.improvement_plan_service.ImprovementPlanService. Presentation
...
services.wellness.plan_progress_service.PlanProgressService instead, so
...
from services.wellness.improvement_plan_service import ImprovementPlan
