...
no new prediction/recommendation logic. See services/social/gamification_service.py,
services/insight/opportunity_cost_service.py, and services/identity/letter_service.py
...
from services.wellness.commitment_service import CommitmentService, STATUS_ACTIVE, STATUS_ABANDONED, STATUS_COMPLETED
from services.wellness.recommendation_effectiveness_service import (
...
from services.social.leaderboard_service import LeaderboardService
from services.social.rare_achievement_service import RareAchievementService
from services.wellness.weekly_challenge_service import WeeklyChallengeService
from services.social.focus_coins_service import FocusCoinsService
...
# services/social/focus_coins_service.py for why this is never a persisted,
...
# (services/ml/cohort_service.py), plus RareAchievementService's real
