...
the model doesn't have. See services/ml/prediction_service.py (unmodified)
...
the regressor (services/ml/prediction_service.py calls
...
(see services/identity/history_service.py's `top_shap_feature`), not the full
...
from services.social.achievement_service import AchievementService
