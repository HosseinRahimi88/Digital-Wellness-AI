...
wiring), `legacy/streamlit_app/pages/Weekly_Insights.py`,
`services/insight/advanced_whatif_service.py`, `utils/persona.py`,
`utils/security.py`.
...
10 new tests in `tests/api/test_api.py`:
